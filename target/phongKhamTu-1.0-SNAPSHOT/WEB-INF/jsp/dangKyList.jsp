...
<div class="list-group">
    <c:forEach var="dangKy" items="${dangKys}" varStatus="1">
        <a href="<c:url value="/admin/dangky/detail/${dangKy.dangKyId}"/>" class="list-group-item list-group-item-action flex-column align-items-start active">
            ...
            <p class="mb-1">Ngày khám: ${dangKy.ngayKham.day}/${dangKy.ngayKham.month}/${dangKy.ngayKham.year+1900}</p>
